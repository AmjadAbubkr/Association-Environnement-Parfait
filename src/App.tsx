...
const photos = {
  hero: `${base}aep-community-cleanup.jpg`,
  people: `${base}aep-team.jpg`,
  trees: `${base}aep-tree-planting.jpg`,
  hands: `${base}aep-awareness.jpg`,
  canopy: `${base}aep-cleanup.jpg`,
};
